                ...
                <div class="card cta-box overflow-hidden">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      ...
                      <img
                        class="ms-3"
                        src="{{url('admin/assets/images/email-campaign.svg')}}"
                        width="92"
                  ...
                  <div class="card-body">
                    ...
                    >
                      <button
                        ...
                        aria-label="Close"
                      ></button>
                      Property HY1xx is not receiving hits. Either your site is
                      not receiving any sessions or it is not tagged correctly.
                    </div>
