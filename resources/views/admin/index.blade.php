            ...
            <div class="leftside-menu">
                ...
                >
                    ...
                    <ul class="side-nav">
                                ...
                                <ul class="side-nav-second-level">
                                    ...
                                    <li>
                                        <a href="apps-projects-gantt.html"
                                            >Gantt
                                            <span
                                                class="badge rounded-pill badge-light-lighten font-10 float-end"
                                                >New</span
                                            ></a
                                        >
                                    </li>
                                    <li>
                                        <a href="apps-projects-add.html"
                                            >Create Project
                                            <span
                                                class="badge rounded-pill badge-success-lighten font-10 float-end"
                                                >New</span
                                            ></a
                                        >
                                    </li>
                        ...
                        <li class="side-nav-title side-nav-item mt-1">
                            Components
                        </li>
                        ...
                        <li class="side-nav-item">
                            ...
                            <div class="collapse" id="sidebarExtendedUI">
                                <ul class="side-nav-second-level">
                                    ...
                                    <li>
                                        <a href="extended-ratings.html"
                                            >Ratings</a
                                        >
                                    </li>
                                    <li>
                                        <a href="extended-scrollbar.html"
                                            >Scrollbar</a
                                        >
                                    </li>
                                    <li>
                                        <a href="extended-scrollspy.html"
                                            >Scrollspy</a
                                        >
                                    </li>
                                    <li>
                                        <a href="extended-treeview.html"
                                            >Treeview</a
                                        >
                                    </li>
                                </ul>
                    ...
                    <div class="help-box text-white text-center">
                        ...
                        <img
                            src="{{url('admin/assets/images/help-icon.svg')}}"
                            height="90"
